...
struct PingRequest {
    ...
    echo_hash: H256,
    // The hash Open Ethereum used to respond with (until rev 01f825b0e1f1c4c420197b51fc801cbe89284b29)
    #[deprecated()]
...
impl<'a> Discovery<'a> {
    ...
    fn on_ping(
        ...
        // WARNING: this field _should not be used_, but old Open Ethereum versions
        // use it in order to get the node's address.
        // So this is a temporary fix so that older Open Ethereum versions don't brake completely.
